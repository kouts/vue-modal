    ...
    <div class="row">
      <div class="col">
        ...
        <button
          ...
          @click="showfirstModal = true; showSecondModal = true;"
        >
          Show all modals
        </button>
      </div>
          ...
          <div class="row modal-footer">
            <div class="col-sm-12">
              <div class="float-left">
                <button class="btn btn-warning" type="button" @click="showSecondModal = true">
                  Open second modal
                </button>
              </div>
              <div class="float-right">
                <button class="btn btn-primary" type="button" @click="showfirstModal = false">
                  Ok
                </button>
                <button
      ...
      <Modal v-model="showSecondModal" title="Second modal">
        <form novalidate>
          ...
          <div class="row modal-footer">
            <div class="col-sm-12">
              <div class="float-right">
                <button class="btn btn-primary" type="button" @click="showSecondModal = false">
                  Ok
                </button>
                <button
                  class="btn btn-secondary ml-2"
