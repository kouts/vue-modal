import { openBlock, createElementBlock, createBlock, Teleport, createVNode, Transition, withCtx, withDirectives, createElementVNode, normalizeClass, normalizeStyle, vShow, renderSlot, toDisplayString, withModifiers, createCommentVNode } from "vue";
...
const _hoisted_2 = ["data-vm-backdrop-id"];
const _hoisted_3 = ["data-vm-wrapper-id", "aria-label"];
const _hoisted_4 = ["data-vm-id"];
const _hoisted_5 = { class: "vm-titlebar" };
const _hoisted_6 = { class: "vm-title" };
const _hoisted_7 = { class: "vm-content" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return $data.mount ? (openBlock(), createElementBlock("div", _hoisted_1, [
            ...
            createElementVNode("div", {
              ...
              renderSlot(_ctx.$slots, "titlebar", {}, () => [
                createElementVNode("div", _hoisted_5, [
                  createElementVNode("h3", _hoisted_6, toDisplayString($props.title), 1),
